...
echo "  - Select 'Florida Lease' (shows '11 optional' fields)"
echo "  - Fill required fields (landlord, tenant, address, rent, dates)"
echo "  - Expand 'Optional Fields (11)'"
echo "  - Scroll down to see user-friendly Yes/No buttons:"
echo ""
echo "    [Lead Paint]"
echo "    'Was this property built before 1978?' --> [Yes] [No]"
echo ""
echo "    [HB 615 Email Consent - Blue highlighted checkbox]"
echo "    [ ] Tenant agrees to receive notices via email..."
echo ""
echo "    [§ 83.512 Flood Disclosure - 3 Yes/No questions]"
echo "    'Has this property experienced flooding?' --> [Yes] [No]"
echo "    'Have you filed flood insurance claims?'  --> [Yes] [No]"
echo "    'Has property received FEMA assistance?'  --> [Yes] [No]"
echo ""
echo "    [Optional text field for flooding description]"
echo ""
echo "  KEY TALKING POINT:"
