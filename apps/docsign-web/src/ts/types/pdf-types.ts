// PDF.js and PdfPreviewBridge type definitions
// Preview-only version for docsign-web (no editing capabilities)
...
/**
 * Page render info cached by PdfPreviewBridge
 */
...
/**
 * PdfPreviewBridge interface - Preview-only (no editing)
 */
export interface IPdfPreviewBridge {
