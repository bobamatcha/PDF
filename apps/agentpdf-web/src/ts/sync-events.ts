 ...
 *
 * Event types:
 * - agentpdf:sync-started - Sync process has begun
 * - agentpdf:sync-completed - All pending items synced successfully
 * - agentpdf:sync-failed - Sync encountered an error
 * - agentpdf:sync-progress - Progress update during sync
 */
...
export const SYNC_EVENTS = {
  STARTED: "agentpdf:sync-started",
  COMPLETED: "agentpdf:sync-completed",
  FAILED: "agentpdf:sync-failed",
  PROGRESS: "agentpdf:sync-progress",
  ONLINE_STATUS_CHANGED: "agentpdf:online-status-changed",
} as const;
