...
pub fn list_templates() -> Vec<TemplateInfo> {
    vec![
        ...
        // Florida Lease Termination Notice - § 83.57, § 83.56, HB 1417
        TemplateInfo {
            name: "florida_lease_termination".to_string(),
            description: "Florida lease termination notice with 7-day, 15-day, and 30-day options per § 83.57 and § 83.56".to_string(),
            uri: "typst://templates/florida_lease_termination".to_string(),
            required_inputs: vec![
                "property_address".to_string(),
                "tenant_name".to_string(),
                "landlord_name".to_string(),
            ...
            optional_inputs: vec![
                ...
                "property_unit".to_string(),
                "property_city".to_string(),
                "property_zip".to_string(),
                "additional_tenant_name".to_string(),
                "notice_type".to_string(), // 7_day_nonpayment, 7_day_noncompliance, 7_day_curable, 15_day, 30_day
                "termination_date".to_string(),
                "amount_due".to_string(),
                "rent_period".to_string(),
        ...
        // Florida Eviction Notice - § 83.56
        TemplateInfo {
            name: "florida_eviction_notice".to_string(),
            description: "Florida eviction notice (3-day pay or quit, 7-day cure, 7-day incurable, 15-day) per § 83.56".to_string(),
            uri: "typst://templates/florida_eviction_notice".to_string(),
            required_inputs: vec![
                "property_address".to_string(),
                "tenant_name".to_string(),
                "landlord_name".to_string(),
            ...
            optional_inputs: vec![
                ...
                "property_city".to_string(),
                "property_zip".to_string(),
                "additional_tenants".to_string(),
                "notice_type".to_string(), // 3_day_pay, 7_day_cure, 7_day_incurable, 15_day
                "rent_period".to_string(),
                "monthly_rent".to_string(),
                "amount_due".to_string(),
                "late_fees".to_string(),
                "total_due".to_string(),
                "violation_description".to_string(),
                "lease_provision".to_string(),
                "termination_date".to_string(),
                "landlord_company".to_string(),
                "landlord_address".to_string(),
                "landlord_city".to_string(),
                "landlord_zip".to_string(),
                "landlord_phone".to_string(),
                "landlord_email".to_string(),
                "payment_address".to_string(),
                "payment_phone".to_string(),
                "service_date".to_string(),
                "service_method".to_string(),
                "include_response_section".to_string(),
            ],
        },
        // Florida Inspection Contingency Addendum
        TemplateInfo {
            name: "florida_inspection_contingency".to_string(),
            description: "Florida inspection contingency addendum with right to cancel or negotiate repairs".to_string(),
            uri: "typst://templates/florida_inspection_contingency".to_string(),
            required_inputs: vec![
                "buyer_name".to_string(),
                "seller_name".to_string(),
                "property_address".to_string(),
            ...
            optional_inputs: vec![
                ...
                "property_zip".to_string(),
                "legal_description".to_string(),
                "buyer2_name".to_string(),
                "seller2_name".to_string(),
                "inspection_days".to_string(),
                "inspection_start_date".to_string(),
                "inspection_end_date".to_string(),
                "contingency_type".to_string(), // right_to_cancel, right_to_negotiate
                "seller_response_days".to_string(),
                "buyer_response_days".to_string(),
                "repair_cap".to_string(),
                "wdo_responsibility".to_string(),
                "wdo_repair_cap".to_string(),
                "deposit_amount".to_string(),
                "escrow_agent".to_string(),
                "additional_terms".to_string(),
                // Inspection types (booleans)
                "general_inspection".to_string(),
                "roof_inspection".to_string(),
                "termite_inspection".to_string(),
                "mold_inspection".to_string(),
                "pool_inspection".to_string(),
                "septic_inspection".to_string(),
                "well_inspection".to_string(),
                "hvac_inspection".to_string(),
                "electrical_inspection".to_string(),
                "plumbing_inspection".to_string(),
                "structural_inspection".to_string(),
                "radon_inspection".to_string(),
                "survey".to_string(),
                "environmental".to_string(),
                "other_inspections".to_string(),
            ],
        },
        // Florida Financing Contingency Addendum
        TemplateInfo {
            name: "florida_financing_contingency".to_string(),
            description: "Florida financing contingency addendum with loan terms and appraisal options".to_string(),
            uri: "typst://templates/florida_financing_contingency".to_string(),
            required_inputs: vec![
                "buyer_name".to_string(),
                "seller_name".to_string(),
                "property_address".to_string(),
            ...
            optional_inputs: vec![
                ...
                "seller2_name".to_string(),
                "loan_amount".to_string(),
                "loan_type".to_string(), // Conventional, FHA, VA, USDA, Other
                "loan_type_other".to_string(),
                "max_interest_rate".to_string(),
                "loan_term".to_string(),
                "down_payment".to_string(),
                "down_payment_percent".to_string(),
                "application_days".to_string(),
                "financing_deadline".to_string(),
                "commitment_notice_days".to_string(),
                "include_appraisal_contingency".to_string(),
                "appraisal_gap".to_string(),
                "default_action".to_string(), // waive, terminate
                "seller_backup_rights".to_string(),
                "backup_response_days".to_string(),
                "lender_name".to_string(),
                "loan_officer".to_string(),
                "lender_phone".to_string(),
                "lender_email".to_string(),
                "lender_nmls".to_string(),
                "deposit_amount".to_string(),
                "escrow_agent".to_string(),
                "escrow_address".to_string(),
                "additional_terms".to_string(),
        ...
        // Florida Notice of Commencement - § 713.13
        TemplateInfo {
            name: "florida_notice_of_commencement".to_string(),
            description: "Florida Notice of Commencement per § 713.13 - required before construction work begins".to_string(),
            uri: "typst://templates/florida_notice_of_commencement".to_string(),
            required_inputs: vec![
                "property_address".to_string(),
                "owner_name".to_string(),
            ...
            optional_inputs: vec![
                ...
                "parcel_id".to_string(),
                "owner_address".to_string(),
                "owner_city".to_string(),
                "owner_state".to_string(),
                "owner_zip".to_string(),
                "owner_phone".to_string(),
                "owner_email".to_string(),
                "owner_interest".to_string(), // fee_simple, lessee, contract_buyer
                "owner2_name".to_string(),
                "contractor_company".to_string(),
                "contractor_address".to_string(),
                "contractor_city".to_string(),
                "contractor_state".to_string(),
                "contractor_zip".to_string(),
                "contractor_phone".to_string(),
                "contractor_email".to_string(),
                "contractor_license".to_string(),
                "has_bond".to_string(),
                "surety_name".to_string(),
                "surety_address".to_string(),
                "surety_city".to_string(),
                "surety_state".to_string(),
                "surety_zip".to_string(),
                "bond_amount".to_string(),
                "bond_number".to_string(),
                "lender_name".to_string(),
                "lender_address".to_string(),
                "lender_city".to_string(),
                "lender_state".to_string(),
                "lender_zip".to_string(),
                "agent_name".to_string(),
                "agent_address".to_string(),
                "agent_city".to_string(),
                "agent_state".to_string(),
                "agent_zip".to_string(),
                "agent_phone".to_string(),
                "project_description".to_string(),
                "commencement_date".to_string(),
                "estimated_completion".to_string(),
                "contract_amount".to_string(),
                "expiration_date".to_string(),
                "notary_county".to_string(),
            ],
        },
        // Florida Notice to Owner - § 713.06
        TemplateInfo {
            name: "florida_notice_to_owner".to_string(),
            description: "Florida Notice to Owner (preliminary notice) per § 713.06 - preserves lien rights".to_string(),
            uri: "typst://templates/florida_notice_to_owner".to_string(),
            required_inputs: vec![
                "property_address".to_string(),
                "owner_name".to_string(),
                "lienor_name".to_string(),
            ],
            optional_inputs: vec![
                "notice_date".to_string(),
                "property_city".to_string(),
                ...
                "contractor_state".to_string(),
                "contractor_zip".to_string(),
                "lienor_company".to_string(),
                "lienor_address".to_string(),
                "lienor_city".to_string(),
                "lienor_state".to_string(),
                "lienor_zip".to_string(),
                "lienor_phone".to_string(),
                "lienor_email".to_string(),
                "lienor_license".to_string(),
                "lienor_type".to_string(), // subcontractor, sub_subcontractor, materialman, laborer, professional, other
                "lienor_type_other".to_string(),
                "lienor_title".to_string(),
                "services_description".to_string(),
                "contracted_with".to_string(),
                "first_furnishing_date".to_string(),
                "contract_amount".to_string(),
                "amount_paid".to_string(),
                "balance_remaining".to_string(),
                "noc_recording_info".to_string(),
                "noc_recording_date".to_string(),
                "has_bond".to_string(),
                "surety_name".to_string(),
                "bond_amount".to_string(),
                "bond_number".to_string(),
                "service_date".to_string(),
                "service_method".to_string(),
                "service_tracking".to_string(),
            ],
        },
        // Florida Claim of Lien - § 713.08
        TemplateInfo {
            name: "florida_claim_of_lien".to_string(),
            description: "Florida Claim of Lien per § 713.08 - must be recorded within 90 days of final furnishing".to_string(),
            uri: "typst://templates/florida_claim_of_lien".to_string(),
            required_inputs: vec![
                "property_address".to_string(),
                "owner_name".to_string(),
                "lienor_name".to_string(),
            ...
            optional_inputs: vec![
                ...
                "return_city".to_string(),
                "return_state".to_string(),
                "return_zip".to_string(),
                "lienor_company".to_string(),
                "lienor_address".to_string(),
                "lienor_city".to_string(),
                "lienor_state".to_string(),
                ...
                "services_description".to_string(),
                "first_furnishing_date".to_string(),
                "last_furnishing_date".to_string(),
                "contract_amount".to_string(),
                "payments_received".to_string(),
                "credits".to_string(),
                "lien_amount_words".to_string(),
                "nto_served".to_string(),
                "nto_date".to_string(),
                "nto_method".to_string(),
                "nto_not_required".to_string(),
                "nto_status".to_string(),
                "noc_recording_info".to_string(),
                "noc_book".to_string(),
                "noc_page".to_string(),
                "noc_instrument".to_string(),
                "has_bond".to_string(),
                "surety_name".to_string(),
                "bond_amount".to_string(),
                "bond_number".to_string(),
                "claim_date".to_string(),
                "notary_county".to_string(),
            ],
        },
        // Florida Release of Lien - § 713.20, § 713.21
        TemplateInfo {
            name: "florida_release_of_lien".to_string(),
            description: "Florida Release/Waiver of Lien per § 713.20 - partial or final, conditional or unconditional".to_string(),
            uri: "typst://templates/florida_release_of_lien".to_string(),
            required_inputs: vec![
                "property_address".to_string(),
                "lienor_name".to_string(),
            ],
            optional_inputs: vec![
                ...
                "lienor_zip".to_string(),
                "lienor_title".to_string(),
                "release_type".to_string(), // partial_conditional, partial_unconditional, final_conditional, final_unconditional
                ...
                "for_recorded_lien".to_string(),
                "parcel_id".to_string(),
                "lien_book".to_string(),
                "lien_page".to_string(),
                "lien_instrument".to_string(),
                "lien_recording_date".to_string(),
                "return_name".to_string(),
                "return_address".to_string(),
                "return_city".to_string(),
                "return_state".to_string(),
                ...
                "include_notary".to_string(),
                "notary_county".to_string(),
            ],
        },
        // Florida Contractor Invoice
        TemplateInfo {
            name: "florida_contractor_invoice".to_string(),
            description: "Florida contractor invoice with lien rights notice and progress billing options".to_string(),
            uri: "typst://templates/florida_contractor_invoice".to_string(),
            required_inputs: vec![
                "company_name".to_string(),
                "client_name".to_string(),
            ...
            optional_inputs: vec![
                ...
                "company_state".to_string(),
                "company_zip".to_string(),
                ...
                "due_date".to_string(),
                "client_address".to_string(),
                "client_city".to_string(),
                "client_state".to_string(),
                "client_zip".to_string(),
                "client_phone".to_string(),
                "client_email".to_string(),
                "project_city".to_string(),
                "project_zip".to_string(),
                "project_name".to_string(),
                "invoice_type".to_string(), // standard, progress
                "application_number".to_string(),
                "period_start".to_string(),
                "period_end".to_string(),
                "line_items".to_string(), // JSON array
                "item1_desc".to_string(),
                "item1_qty".to_string(),
                "item1_price".to_string(),
                "item1_amount".to_string(),
                "item2_desc".to_string(),
                "item2_qty".to_string(),
                "item2_price".to_string(),
                "item2_amount".to_string(),
                "item3_desc".to_string(),
                "item3_qty".to_string(),
                "item3_price".to_string(),
                "item3_amount".to_string(),
                "item4_desc".to_string(),
                "item4_qty".to_string(),
                "item4_price".to_string(),
                "item4_amount".to_string(),
                "item5_desc".to_string(),
                "item5_qty".to_string(),
                "item5_price".to_string(),
                "item5_amount".to_string(),
                "subtotal".to_string(),
                "discount".to_string(),
                "previous_billings".to_string(),
                "taxable".to_string(),
                "tax_rate".to_string(),
                "tax_amount".to_string(),
                "total_due".to_string(),
                "contract_reference".to_string(),
                "contract_date".to_string(),
                "contract_amount".to_string(),
                "original_contract".to_string(),
                "change_orders".to_string(),
                "revised_contract".to_string(),
                "completed_to_date".to_string(),
                "retainage_percent".to_string(),
                "retainage_amount".to_string(),
                "previous_payments".to_string(),
                "current_due".to_string(),
                "payment_terms".to_string(),
                "bank_info".to_string(),
                "accept_credit".to_string(),
                "late_fee_info".to_string(),
                "late_fee_percent".to_string(),
                "late_fee_apr".to_string(),
                "notes".to_string(),
                "requires_approval".to_string(),
            ],
        },
        // Florida Motor Vehicle Bill of Sale - Chapter 319
        TemplateInfo {
            name: "florida_bill_of_sale_car".to_string(),
            description: "Florida motor vehicle bill of sale with odometer disclosure per Chapter 319".to_string(),
            uri: "typst://templates/florida_bill_of_sale_car".to_string(),
            required_inputs: vec![
                "seller_name".to_string(),
                "buyer_name".to_string(),
                "vin".to_string(),
            ...
            optional_inputs: vec![
                "sale_date".to_string(),
                "vehicle_year".to_string(),
                "vehicle_make".to_string(),
                "vehicle_model".to_string(),
                "body_style".to_string(),
                "vehicle_color".to_string(),
                "odometer".to_string(),
                "odometer_status".to_string(), // actual, exceeds, not_actual
                "plate_number".to_string(),
                "title_number".to_string(),
                "seller_address".to_string(),
                "seller_city".to_string(),
                "seller_state".to_string(),
                "seller_zip".to_string(),
                "seller_phone".to_string(),
                "seller_dl".to_string(),
                "buyer_address".to_string(),
                "buyer_city".to_string(),
                "buyer_state".to_string(),
                "buyer_zip".to_string(),
                "buyer_phone".to_string(),
                "buyer_dl".to_string(),
                "purchase_price".to_string(),
                "trade_in_value".to_string(),
                "down_payment".to_string(),
                "total_paid".to_string(),
                "payment_method".to_string(), // cash, check, certified_check, financing
                "check_number".to_string(),
                "lender_name".to_string(),
                "sale_type".to_string(), // as_is, warranty
                "warranty_terms".to_string(),
                "known_defects".to_string(),
                "has_lien".to_string(),
                "lien_holder".to_string(),
                "include_notary".to_string(),
                "notary_county".to_string(),
            ],
        },
        // Florida Vessel/Boat Bill of Sale - Chapter 328
        TemplateInfo {
            name: "florida_bill_of_sale_boat".to_string(),
            description: "Florida vessel/boat bill of sale per Chapter 328 with HIN and engine info".to_string(),
            uri: "typst://templates/florida_bill_of_sale_boat".to_string(),
            required_inputs: vec![
                "seller_name".to_string(),
                "buyer_name".to_string(),
                "hin".to_string(),
            ...
            optional_inputs: vec![
                "sale_date".to_string(),
                "vessel_year".to_string(),
                "vessel_make".to_string(),
                "vessel_model".to_string(),
                "hull_material".to_string(),
                "vessel_length".to_string(),
                "vessel_beam".to_string(),
                "registration_number".to_string(),
                "title_number".to_string(),
                "propulsion".to_string(),
                "primary_use".to_string(),
                "engine1_make".to_string(),
                "engine1_model".to_string(),
                "engine1_serial".to_string(),
                "engine2_make".to_string(),
                "engine2_model".to_string(),
                "engine2_serial".to_string(),
                "total_hp".to_string(),
                "includes_trailer".to_string(),
                "trailer_year".to_string(),
                "trailer_make".to_string(),
                "trailer_vin".to_string(),
                "trailer_plate".to_string(),
                "seller_address".to_string(),
                "seller_city".to_string(),
                "seller_state".to_string(),
                "seller_zip".to_string(),
                ...
                "buyer_phone".to_string(),
                "buyer_dl".to_string(),
                "vessel_price".to_string(),
                "trailer_value".to_string(),
                "accessories_value".to_string(),
                "total_price".to_string(),
                "payment_method".to_string(),
                "check_number".to_string(),
                "lender_name".to_string(),
                "included_equipment".to_string(),
                "sale_type".to_string(),
                "warranty_terms".to_string(),
                "known_defects".to_string(),
                "has_lien".to_string(),
        ...
        // Florida Trailer Bill of Sale - Chapters 319 & 320
        TemplateInfo {
            name: "florida_bill_of_sale_trailer".to_string(),
            description: "Florida trailer bill of sale per Chapters 319 & 320".to_string(),
            uri: "typst://templates/florida_bill_of_sale_trailer".to_string(),
            required_inputs: vec![
                "seller_name".to_string(),
                "buyer_name".to_string(),
                "vin".to_string(),
            ...
            optional_inputs: vec![
                ...
                "trailer_year".to_string(),
                "trailer_make".to_string(),
                "trailer_model".to_string(),
                "trailer_type".to_string(),
                "trailer_color".to_string(),
                "trailer_length".to_string(),
                "trailer_width".to_string(),
                "gvwr".to_string(),
                "axle_count".to_string(),
                "plate_number".to_string(),
                "title_number".to_string(),
                "seller_address".to_string(),
                "seller_city".to_string(),
        ...
        // Florida Personal Watercraft (Jet Ski) Bill of Sale - Chapter 328
        TemplateInfo {
            name: "florida_bill_of_sale_jetski".to_string(),
            description: "Florida personal watercraft (Jet Ski/PWC) bill of sale per Chapter 328".to_string(),
            uri: "typst://templates/florida_bill_of_sale_jetski".to_string(),
            required_inputs: vec![
                "seller_name".to_string(),
                "buyer_name".to_string(),
                "hin".to_string(),
            ...
            optional_inputs: vec![
                ...
                "pwc_model".to_string(),
                "pwc_color".to_string(),
                "engine_size".to_string(),
                "horsepower".to_string(),
                "registration_number".to_string(),
                "title_number".to_string(),
                "engine_hours".to_string(),
                "includes_trailer".to_string(),
                "trailer_year".to_string(),
                "trailer_make".to_string(),
                "trailer_vin".to_string(),
                "trailer_plate".to_string(),
                "trailer_title".to_string(),
                "seller_address".to_string(),
                "seller_city".to_string(),
                "seller_state".to_string(),
                "seller_zip".to_string(),
        ...
        // Florida Mobile Home Bill of Sale - Chapters 319 & 723
        TemplateInfo {
            name: "florida_bill_of_sale_mobile_home".to_string(),
            description: "Florida mobile/manufactured home bill of sale per Chapters 319 & 723".to_string(),
            uri: "typst://templates/florida_bill_of_sale_mobile_home".to_string(),
            required_inputs: vec![
                "seller_name".to_string(),
                "buyer_name".to_string(),
                "vin".to_string(),
            ...
            optional_inputs: vec![
                ...
                "vin2".to_string(),
                "title_number".to_string(),
                "hud_number".to_string(),
                "location_address".to_string(),
                "park_name".to_string(),
                "location_city".to_string(),
                "location_zip".to_string(),
                "location_county".to_string(),
                "seller_address".to_string(),
                "seller_city".to_string(),
                "seller_state".to_string(),
                "seller_zip".to_string(),
                ...
                "buyer_dl".to_string(),
                "purchase_price".to_string(),
                "personal_property_value".to_string(),
                "down_payment".to_string(),
                "total_price".to_string(),
                "payment_method".to_string(),
                "check_number".to_string(),
                "lender_name".to_string(),
                "include_appliances".to_string(),
                "appliances_list".to_string(),
                "include_ac".to_string(),
                "include_skirting".to_string(),
                "include_steps".to_string(),
                "include_shed".to_string(),
                "other_included".to_string(),
                "sale_type".to_string(),
                "warranty_terms".to_string(),
                "known_defects".to_string(),
                "lot_rent".to_string(),
                "park_approval_obtained".to_string(),
                "has_lien".to_string(),
                "lien_holder".to_string(),
                "notary_county".to_string(),
            ],
